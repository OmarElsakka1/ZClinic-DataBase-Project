...
namespace ZClinic
{
    public partial class MedicalExcuseAcceptedDeclined : UserControl
    {
        ...
        public MedicalExcuseAcceptedDeclined()
        {
            InitializeComponent();
            
        }

        private void MedicalExcuseAcceptedDeclined_Load(object sender, EventArgs e)
        {
            ...
            bunifuCustomLabel9.Text = ExcuseID;
        }

        private void bunifuImageButton1_Click(object sender, EventArgs e)
        {
            MedicalExcuses.Instance.RemoveExecAccep(this);
            MedicalExcuses.Instance.RemoveExecDenied(this);
